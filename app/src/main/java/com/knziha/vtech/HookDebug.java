...
public class HookDebug implements IXposedHookLoadPackage {
	//按照实际使用情况修改下面几项的值
	/**
	 * 当前Xposed模块的包名,方便寻找apk文件
	 */
	private final String modulePackage = "com.knziha.vtech";
	/**
	...
	static {
		...
		hostAppPackages.add("com.knziha.vtech");
	}
	
	/**
	 * 实际hook逻辑处理类
	 */
	private final String handleHookClass = HookTest.class.getName();
	/**
	 * 实际hook逻辑处理类的入口方法
	 */
